...
# DATA
# X, Xd, y = ToyData.sample(1000, durations=False)
...
gpa = GlobalPatternAnalysis(X_flat, Xd_flat, L=20, num_it=500, eval_intervals=[(100, 250), (250, 490), (450, 500)], model_save_path='model_example_4c',
                            verbose=True)
