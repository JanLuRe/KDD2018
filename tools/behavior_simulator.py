...
class BehaviorGenerator:
    def __init__(self):
        ...
        human_super_state_space_card = 12 
        bot_super_state_space_card = 12 
        shared_super_state_space_card = 13 
        ...
        self.state_space_cardinality = 50
...
bg.sample(n=10000, size=25000000)
print(np.sum([len(session) for e in bg.data for session in e]))
with open('/media/robzer/48C8573DC8572888/.work/www18/run_25m/synth_behavior_data_3c_100_25k25m.pckl', 'wb') as f:
